...
The code will query the native function WiFi.RSSI() to fetch the raw decibel value (dBm) and map it into a clear, reader-friendly format (Excellent, Good, Fair, or Poor).
